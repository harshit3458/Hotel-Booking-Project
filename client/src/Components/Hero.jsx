...
const Hero = () => {
    ...
    const onSearch=async (e)=>{
      ...
      // add destination to searchedcities
  ...
  return (
    ...
    bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
      ...
      <p className='max-w-130 mt-2 text-sm md:text-base'>Unparelleled luxury and comfort await at the world's most exclusive hotels and resorts. Start your 
        journey today.
      </p>
