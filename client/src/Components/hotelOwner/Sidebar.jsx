  ...
  return (
    ...
    flex flex-col transition-all duration-300'>
      {sidebarLinks.map((item,index)=>(
        ...
        `flex items-center py-3 px-4 md:px-8 gap-3 ${isActive ? "border-r-4 md:border-r-6px bg-blue-600/10 border-blue-600 text-blue-600" : "hover:bg-gray-100/90 border-while text-gray-700"}`}>
