...
const AddRoom = () => {
  ...
  return (
    <form>
      <Title align="left" font="outfit" title="Add Room" subTitle='Fill in the details careful and accurate room details, pricing
      ...
      <div>
        ...
        <input type="number" placeholder='0' className='border border-gray-300 mt-1 rounded
        p-2 w-24' value={inputs.pricePerNight} onChange={e=>setInputs({...inputs,pricePerNight:e.target.value})} />
      </div>
      </div>
