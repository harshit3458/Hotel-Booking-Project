           ...
           <table className='w-full'>
            <thead className='bg-gray-50'>
                <tr>
                  ...
                  <th className='py-3 px-4 text-gray-800 text-center font-medium'>Total Amount</th>
                  <th className='py-3 px-4 text-gray-800 text-center font-medium'>Payment Status</th>
                </tr>
            </thead>
